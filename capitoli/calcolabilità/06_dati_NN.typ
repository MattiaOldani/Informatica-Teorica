...
#figure(image("assets/cantor-01.svg", width: 50%))
...
#figure(image("assets/cantor-02.svg", width: 40%))
...
#figure(image("assets/cantor-03.svg", width: 15%))
...
#figure(image("assets/grafo.svg", width: 25%))
