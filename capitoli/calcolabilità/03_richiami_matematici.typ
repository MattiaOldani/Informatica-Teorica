...
- $forall i,j in NN^+ bar.v i eq.not j$ allora $A_i inter A_j = emptyset$;
...
- dati $a,b in A$ allora $[a]_R inter [b]_R = emptyset$ oppure $[a]_R = [b]_R$, garantito dal fatto che due elementi o sono in relazione o non lo sono;
